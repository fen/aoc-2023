...
await SolveAsync<AdventOfCode.Solutions.Day21.PartTwo>(GetInputFile(21));
...
await SolveAsync<AdventOfCode.Solutions.Day24.PartTwo>(GetInputFile(24));
await SolveAsync<AdventOfCode.Solutions.Day25.PartOne>(GetInputFile(25));
